...
import { buildBackend, resolveBackendName, } from "./adapters/ai_review/index.js";
import { AI_REVIEW_MAX_ATTEMPTS as PIPELINE_AI_REVIEW_MAX_ATTEMPTS, AI_REVIEW_SYSTEM_PROMPT as PIPELINE_AI_REVIEW_SYSTEM_PROMPT, buildReviewBatches as pipelineBuildReviewBatches, buildReviewPrompt as pipelineBuildReviewPrompt, extractJsonPatch as pipelineExtractJsonPatch, formatRejectedPatchWarning as pipelineFormatRejectedPatchWarning, validateAiReviewPatch as pipelineValidateAiReviewPatch, } from "./adapters/ai_review/review_pipeline.js";
...
function resolveAiReviewBackend(context, params, config) {
