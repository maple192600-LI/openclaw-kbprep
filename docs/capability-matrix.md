...
| code_direct | Code/config files | direct_code | verified | exact code, parameters, comments, link strings | converts GitHub-style source and config files as fenced Markdown without summarizing code | code must be protected from prose cleanup |
