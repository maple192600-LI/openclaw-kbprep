...
- `#4`: The old generated docs website was removed from the maintained docs surface. Current docs stay focused on the core flow, implementation plan, capability matrix, quality loop, feedback learning, CLI usage, and host-neutral install notes.
